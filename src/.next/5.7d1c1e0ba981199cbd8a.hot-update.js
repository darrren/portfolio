...
const AttrPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine.plugin({
	propName: "attr",
	API: 2,
	version: "0.6.1",
 ...
 **/
		...
		var _RAD2DEG = 180 / Math.PI,
			...
			_r3 = [],
			_corProps = {},
			_globals = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine.globals,
			...
			BezierPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine.plugin({
					propName: "bezier",
					priority: -1,
					version: "1.3.8",
					API: 2,
 ...
 */
	...
	__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function() {
		...
		var _numExp = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
			...
			_forcePT = {},
			_dummyElement = {style:{}},
			_doc = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].document || {createElement: function() {return _dummyElement;}},
			...
			_agent = (__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].navigator || {}).userAgent || "",
			_autoRound,
			...
			_log = function(s) {//for logging messages, but in a way that won't throw errors in old versions of IE.
				if (__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].console) {
					console.log(s);
				}
			},
			...
			_convertToPixels = _internals.convertToPixels = function(t, p, v, sfx, recurse) {
				...
				if (p === "lineHeight" && !sfx) { //special case of when a simple lineHeight (without a unit) is used. Set it to the value, read back the computed value, and then revert.
					...
					if (sfx === "%" || !node.appendChild || sfx.charAt(0) === "v" || sfx === "rem") {
						...
						cache = node._gsCache;
						time = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].ticker.frame;
		...
		if (!__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].defaultStringFilter) {
			__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].defaultStringFilter = CSSPlugin.colorStringFilter;
		}
		...
		var _transformProps = ("scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent").split(","),
			...
			_SVGElement = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].SVGElement,
			...
			_forceSVGTransformAttr = (function() {
				...
				var force = _ieVers || (/Android/i.test(_agent) && !__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].chrome),
					svg, rect, width;
				...
				if (rec) {
					...
					if (tm.svg) { //if we're supposed to apply transforms to the SVG element's "transform" attribute, make sure there aren't any CSS transforms applied or they'll override the attribute ones. Also clear the transform attribute if we're using CSS, just to be clean.
						if (_useSVGTransformAttr && t.style[_transformProp]) {
							__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].delayedCall(0.001, function(){ //if we apply this right away (before anything has rendered), we risk there being no transforms for a brief moment and it also interferes with adjusting the transformOrigin in a tween with immediateRender:true (it'd try reading the matrix and it wouldn't have the appropriate data in place because we just removed it).
								_removeProp(t.style, _transformProp);
							});
						} else if (!_useSVGTransformAttr && t.getAttribute("transform")) {
							__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].delayedCall(0.001, function(){
		...
		CSSPlugin.cascadeTo = function(target, duration, vars) {
			var tween = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].to(target, duration, vars),
				results = [tween],
				b = [],
				e = [],
				targets = [],
				_reservedProps = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */]._internals.reservedProps,
				i, difs, p, from;
			...
			while (--i > -1) {
				...
				if (difs.firstMPT) {
					...
					results.push(__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].fromTo(targets[i], duration, from, difs));
				}
			}
			return results;
		};
...
const CSSPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].CSSPlugin;
...
const DirectionalRotationPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine.plugin({
...
__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine("easing.Back", ["easing.Ease"], function() {
		
		var w = (__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].GreenSockGlobals || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]),
			gs = w.com.greensock,
			_2PI = Math.PI * 2,
			_HALF_PI = Math.PI / 2,
			_class = gs._class,
...
const Back = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].Back;
/* harmony export (immutable) */ __webpack_exports__["a"] = Back;

const Elastic = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].Elastic;
/* harmony export (immutable) */ __webpack_exports__["d"] = Elastic;

const Bounce = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].Bounce;
/* harmony export (immutable) */ __webpack_exports__["b"] = Bounce;

const RoughEase = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].RoughEase;
/* harmony export (immutable) */ __webpack_exports__["g"] = RoughEase;

const SlowMo = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].SlowMo;
/* harmony export (immutable) */ __webpack_exports__["i"] = SlowMo;

const SteppedEase = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].SteppedEase;
/* harmony export (immutable) */ __webpack_exports__["j"] = SteppedEase;

const Circ = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].Circ;
/* harmony export (immutable) */ __webpack_exports__["c"] = Circ;

const Expo = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].Expo;
/* harmony export (immutable) */ __webpack_exports__["e"] = Expo;

const Sine = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].Sine;
/* harmony export (immutable) */ __webpack_exports__["h"] = Sine;

const ExpoScaleEase = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].ExpoScaleEase;
...
const RoundPropsPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine.plugin({
				propName: "roundProps",
				version: "1.7.0",
				priority: -1,
				API: 2,
...
__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine("TimelineLite", ["core.Animation","core.SimpleTimeline","TweenLite"], function() {
		...
		var TimelineLite = function(vars) {
			...
			TweenLiteInternals = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */]._internals,
		...
		*/
		...
		p.to = function(target, duration, vars, position) {
			var Engine = (vars.repeat && _globals.TweenMax) || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */];
			return duration ? this.add( new Engine(target, duration, vars), position) : this.set(target, vars, position);
		};

		p.from = function(target, duration, vars, position) {
			return this.add( ((vars.repeat && _globals.TweenMax) || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */]).from(target, duration, vars), position);
		};

		p.fromTo = function(target, duration, fromVars, toVars, position) {
			var Engine = (toVars.repeat && _globals.TweenMax) || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */];
		...
		p.staggerTo = function(targets, duration, vars, stagger, position, onCompleteAll, onCompleteAllParams, onCompleteAllScope) {
			...
			if (typeof(targets) === "string") {
				targets = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].selector(targets) || targets;
			}
			targets = targets || [];
		...
		p.call = function(callback, params, scope, position) {
			return this.add( __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].delayedCall(0, callback, params, scope), position);
		};
		...
		p.set = function(target, vars, position) {
			...
			return this.add( new __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */](target, 0, vars), position);
		};
		...
		TimelineLite.exportRoot = function(vars, ignoreDelayedCalls) {
			...
			while (tween) {
				next = tween._next;
				if (!ignoreDelayedCalls || !(tween instanceof __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */] && tween.target === tween.vars.onComplete)) {
		...
		p.add = function(value, position, align, stagger) {
			...
			if (!(value instanceof __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["a" /* Animation */])) {
				if ((value instanceof Array) || (value && value.push && _isArray(value))) {
					...
					value = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].delayedCall(0, value);
				} else {
					throw("Cannot add " + value + " into the timeline; it is not a tween, timeline, function, or string.");
				}
			}

			__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["e" /* SimpleTimeline */].prototype.add.call(this, value, position);
		...
		p.addPause = function(position, callback, params, scope) {
			var t = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].delayedCall(0, _pauseCallback, params, scope || this);
		...
		p.getChildren = function(nested, tweens, timelines, ignoreBeforeTime) {
			...
			while (tween) {
				if (tween._startTime < ignoreBeforeTime) {
					//do nothing
				} else if (tween instanceof __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */]) {
					if (tweens !== false) {
						a[cnt++] = tween;
					}
				} else {
		...
		p.getTweensOf = function(target, nested) {
			...
			tweens = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].getTweensOf(target);
			i = tweens.length;
			while (--i > -1) {
...
const TimelineLite = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].TimelineLite;
...
__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine("TimelineMax", ["TimelineLite","TweenLite","easing.Ease"], function() {
		...
		p.tweenTo = function(position, vars) {
			...
			var copy = {ease:_easeNone, useFrames:this.usesFrames(), immediateRender:false, lazy:false},
				Engine = (vars.repeat && _globals.TweenMax) || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */],
				duration, p, t;
			for (p in vars) {
				copy[p] = vars[p];
			}
...
const TimelineMax = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].TimelineMax;
...
/* harmony export (immutable) */ __webpack_exports__["e"] = SimpleTimeline;
...
/* harmony export (immutable) */ __webpack_exports__["c"] = Power2;

const Power3 = _gsScope.Power3;
/* unused harmony export Power3 */

const Power4 = _gsScope.Power4;
/* harmony export (immutable) */ __webpack_exports__["d"] = Power4;
...
__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */]._gsDefine("TweenMax", ["core.Animation","core.SimpleTimeline","TweenLite"], function() {
		...
		var _slice = function(a) { //don't use [].slice because that doesn't work in IE8 with a NodeList that's returned by querySelectorAll()
			...
			TweenMax = function(target, duration, vars) {
				__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].call(this, target, duration, vars);
				this._cycle = 0;
			...
			_isSelector = TweenLiteInternals.isSelector,
			_isArray = TweenLiteInternals.isArray,
			p = TweenMax.prototype = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].to({}, 0.1, {}),
			_blankArray = [];

		TweenMax.version = "2.0.1";
		p.constructor = TweenMax;
		p.kill()._gc = false;
		TweenMax.killTweensOf = TweenMax.killDelayedCallsTo = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].killTweensOf;
		TweenMax.getTweensOf = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].getTweensOf;
		TweenMax.lagSmoothing = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].lagSmoothing;
		TweenMax.ticker = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].ticker;
		TweenMax.render = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].render;
		...
		p.invalidate = function() {
			...
			this._yoyoEase = null;
			this._uncache(true);
			return __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].prototype.invalidate.call(this);
		};
			...
			if (this._initted || immediate) {
				if (resetDuration) {
					...
					if (this._notifyPluginsOfEnabled && this._firstPT) {
						__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */]._onPluginEvent("_onDisable", this); //in case a plugin like MotionBlur must perform some cleanup tasks
					}
						...
						if (yoyoEase) {
							if (!this._yoyoEase) {
								if (yoyoEase === true && !this._initted) { //if it's not initted and yoyoEase is true, this._ease won't have been populated yet so we must discern it here.
									...
									this._yoyoEase = yoyoEase = !yoyoEase ? __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].defaultEase : (yoyoEase instanceof __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["b" /* Ease */]) ? yoyoEase : (typeof(yoyoEase) === "function") ? new __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["b" /* Ease */](yoyoEase, this.vars.easeParams) : __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["b" /* Ease */].map[yoyoEase] || __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].defaultEase;
								} else {
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		...
		TweenMax.isTweening = function(target) {
			return (__WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].getTweensOf(target, true).length > 0);
		};
		...
		var _getChildrenOf = function(timeline, includeTimelines) {
				...
				while (tween) {
					if (tween instanceof __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */]) {
						a[cnt++] = tween;
					} else {
						if (includeTimelines) {
							a[cnt++] = tween;
		...
		TweenMax.killChildTweensOf = function(parent, complete) {
			...
			if (typeof(parent) === "string") {
				parent = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].selector(parent) || parent;
			}
		...
		TweenMax.globalTimeScale = function(value) {
			var tl = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["a" /* Animation */]._rootTimeline,
				t = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].ticker.time;
			if (!arguments.length) {
			...
			t = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["h" /* default */].ticker.frame;
			tl._startTime = t - ((t - tl._startTime) * tl._timeScale / value);
...
const TweenMax = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["g" /* _gsScope */].TweenMax;
/* unused harmony export TweenMax */
...
/* unused harmony reexport Power3 */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["d"]; });
/* unused harmony reexport Linear */
/* unused harmony reexport Back */
/* unused harmony reexport Elastic */
/* unused harmony reexport Bounce */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lib_withI18next__ = __webpack_require__("./lib/withI18next.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Fireflies__ = __webpack_require__("./pages/home/Fireflies.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_js__ = __webpack_require__("./pages/home/style.js");
...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      __WEBPACK_IMPORTED_MODULE_2_gsap__["c" /* TweenMax */].set('.intro h1, .intro h2, .intro h3', {
        x: 20,
        rotationY: 5,
        scale: 0.85,
        autoAlpha: 0,
      ...
      __WEBPACK_IMPORTED_MODULE_2_gsap__["c" /* TweenMax */].staggerTo('.intro h1, .intro h2, .intro h3', 1, {
        x: 0,
        rotationY: 0,
        scale: 1,
        autoAlpha: 1,
        ease: __WEBPACK_IMPORTED_MODULE_2_gsap__["a" /* Power2 */].easeOut,
        delay: 1
      }, 0.2);
    }
  }, {
    ...
    value: function render() {
      var t = this.props.t;
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__style_js__["b" /* HomeContainer */], null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Fireflies__["a" /* default */], null), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", {
        className: "intro"
...
Object.defineProperty(Home, "propTypes", {
  ...
  writable: true,
  value: {
    t: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.any // static async getInitialProps ({ query, res }) {
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_3__lib_withI18next__["a" /* withI18next */])(['home', 'common'])(Home));
...
//# sourceMappingURL=5.7d1c1e0ba981199cbd8a.hot-update.js.map